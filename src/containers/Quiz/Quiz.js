    ...
    titlePage: [
      {
        ...
        textTest: '<p style="text-indent:47px">Спорим, вы пытались поставить себе диагноз или найти способ оказания первой медицинской помощи через интернет-поисковики? Бывает, что недуг застает вечером или в дороге, медучреждения уже закрыты, а весомых поводов вызывать скорую помощь нет.  И тогда мы обращаемся к интернету.</p><p style="text-indent:47px">В этом тесте, который "СарИнформ" создал вместе с телемедицинским сервисом <a href="https://www.smartmed.pro/" style="text-decoration:none;color: #ef5b57;">SmartMed</a>, разработанным МТС и федеральной сетью клиник МЕДСИ, предлагаем безопасно проверить качество помощи из поисковиков.</p><p style="text-indent:47px">Правила такие: мы показываем предполагаемый поисковый запрос, а вы выбираете наиболее подходящий ответ из поисковой выдачи. Сразу предупредим, что абсолютно правильных ответов в тесте нет: каждый случай индивидуален, и правильнее  проконсультироваться с врачом в поликлинике или онлайн, а не искать самостоятельно способ лечения в интернете.</p>',
      }
    ],
    quiz: dq
  }
